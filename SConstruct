...
sources = [Glob("src/*.cpp"), Glob("src/cpp/*.cpp"), Glob("src/rust/*.cpp"), Glob("src/zig/*.cpp"), Glob("src/elf/*.cpp"), Glob("src/godot/*.cpp"), Glob("src/safegdscript/*.cpp"), ["src/gdscript/compiler/function_signature.cpp", "src/gdscript/compiler/line_table.cpp", "src/gdscript/compiler/gdsmeta.cpp", "src/gdscript/compiler/globals.cpp", "src/gdscript/compiler/compiler_exception.cpp"], ["src/tests/dummy_assault.cpp"], Glob("src/bintr/*.cpp")]
