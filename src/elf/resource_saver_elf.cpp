...
Error ResourceFormatSaverELF::_save(const Ref<Resource> &p_resource, const String &p_path, uint32_t p_flags) {
	...
	Ref<ELFScript> elf_model = fast_cast_to<ELFScript>(p_resource.ptr());
